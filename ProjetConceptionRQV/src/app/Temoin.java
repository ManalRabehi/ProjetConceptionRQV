...
public class Temoin extends Personne{
	 public Temoin(String cni, String nom, String prenom, Role role, String adresse, String telephone){
	    ...
	    public void update(String message){
	        System.out.println("Notification envoyée au témoin : " + nom + " " + prenom);
	    }
